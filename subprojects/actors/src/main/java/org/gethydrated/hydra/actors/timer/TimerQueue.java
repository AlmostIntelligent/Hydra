...
public interface TimerQueue {
    ...
    /**
     * Returns a queue dependent runnable, that is responsible for tick
     * generation.
     * 
    ...
    /**
     * Stops current queue workers and returns all unhandled {@link Timeout}
     * objects.
     * 
     * @return {@link Timeout} objects that were not yet handled by the queue
     *         worker.
     */
    Set<Timeout> stop();
